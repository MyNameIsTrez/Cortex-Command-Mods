return {
	...
	GameActivity = {
		...
		DefaultGoldHard = -1,
		DefaultGoldNuts = -1,
		FogOfWarSwitchEnabled = true,
		DeployUnitsSwitchEnabled = true,
		GoldSwitchEnabled = true,
		RequireClearPathToOrbitSwitchEnabled = true,
		BuyMenuEnabled = true,
	},
	GAScripted = {
		ScriptPath = ,
	...
	SettingsMan = {
		...
		DisableFactionBuyMenuThemeCursors = ,
		PathFinderGridNodeSize = ,
		AIUpdateInterval = ,
