return {
	...
	MOSRotating = {
		DeepCheck = "Whether or not to check for deep penetrations.",
		...
		GibAtEndOfLifetime = "Whether or not this MOSRotating should gib when it reaches the end of its lifetime, instead of just deleting.",
	...
	MovableObject = {
		...
		HitsMOs = "Whether or not this MovableObject will test for collisions against other MOs.",
		GetsHitByMOs = "Whether or not this MovableObject can get hit by other MOs.",
		...
		ScriptPath = "Path to a Lua script file to run.",
		...
		EffectStopTime = "Effect's ending this far into the lifetime of this, in ms. 0 means as long as this is alive.",
		...
		ApplyWoundDamageOnCollision = "Whether or not this should apply wound damage on collision, respecting WoundDamageMultiplier and without creating a wound.",
		ApplyWoundBurstDamageOnCollision = "Whether or not this should apply wound burst damage on collision, respecting WoundDamageMultiplier and without creating a wound.",
	...
	PieMenu = {
		...
		DrawBackgroundTransparent = "Whether or not the PieMenu's background should be drawn transparently.",
	...
	PieSlice = {
		...
		CanBeMiddleSlice = "Whether or not this PieSlice is allowed to be the middle slice. Defaults to true and should usually stay that way.",
		...
		DrawFlippedToMatchAbsoluteAngle = "Whether or not this PieSlice should draw flipped based on its absolute angle (i.e. its angle accounting for its pie menu's rotation).",
	},
	Round = {
		ParticleCount = "How many particle copies there are in this Round.",
		FireVelocity = "The velocity with which this Round is fired.",
		InheritsFirerVelocity = "Whether or not this Round should inherit velocity from its firer.",
	...
	SettingsMan = {
		...
		AlwaysDisplayUnheldItemsInStrategicMode = "Whether or not devices on Scene should always show their pick-up HUD when when the player is in strategic mode.",
