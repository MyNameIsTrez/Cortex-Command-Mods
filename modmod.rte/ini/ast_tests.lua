...
function M.ast_tests()
	...
	ast_test("comment_before_tabs", {
		{
			...
			value_pointer = cst[1][5],
			children = {
				{
					property_pointer = cst[1][7].content[1][2],
					value_pointer = cst[1][7].content[1][6],
					children = {
						{
							property_pointer = cst[1][7].content[1][8].content[1][2],
							value_pointer = cst[1][7].content[1][8].content[1][6],
							children = {
								{
									property_pointer = cst[1][7].content[1][8].content[1][8].content[1][3],
									value_pointer = cst[1][7].content[1][8].content[1][8].content[1][7],
								},
								{
									property_pointer = cst[1][7].content[1][8].content[1][8].content[2][2],
									value_pointer = cst[1][7].content[1][8].content[1][8].content[2][6],
								},
							},
						},
					},
					...
					children = {
						{
							...
							children = {
								{
									property_pointer = cst[1][7].content[1][8].content[1][8].content[1][4],
									value_pointer = cst[1][7].content[1][8].content[1][8].content[1][8],
								},
								{
									property_pointer = cst[1][7].content[1][8].content[1][8].content[2][2],
									value_pointer = cst[1][7].content[1][8].content[1][8].content[2][6],
	...
	ast_test("complex", {
		{
			property_pointer = cst[1][5],
			value_pointer = cst[1][9],
			children = {
	...
	ast_test("datamodule", {
		{
			...
			children = {
				{
					property_pointer = cst[1][3].content[1][2],
					value_pointer = cst[1][3].content[1][6],
					children = {
						{
							property_pointer = cst[1][3].content[1][8].content[1][2],
							value_pointer = cst[1][3].content[1][8].content[1][6],
						},
					},
				},
			...
			children = {
				{
					...
					children = {
						...
						{
							property_pointer = cst[1][7].content[1][8].content[2][2],
							value_pointer = cst[1][7].content[1][8].content[2][6],
						},
						{
							property_pointer = cst[1][7].content[1][8].content[3][2],
							value_pointer = cst[1][7].content[1][8].content[3][6],
						},
						{
							property_pointer = cst[1][7].content[1][8].content[4][2],
							value_pointer = cst[1][7].content[1][8].content[4][6],
						},
						{
							property_pointer = cst[1][7].content[1][8].content[5][2],
							value_pointer = cst[1][7].content[1][8].content[5][6],
						},
						{
							property_pointer = cst[1][7].content[1][8].content[6][2],
							value_pointer = cst[1][7].content[1][8].content[6][6],
						},
					},
				},
			},
	...
	ast_test("multiple", {
		...
		{
			property_pointer = cst[2][1],
			value_pointer = cst[2][5],
			children = {
